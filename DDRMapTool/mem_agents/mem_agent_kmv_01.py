...
class MemAgent_KMV_01(MemAgent):
    ...
    def calc_memory(self):
        KMV_01_frame_rate = ME_out_framerate
        KMV_01_bits = 21
        KMV_01_H_res = MC_H_Hact/ME1_block_size_H
        KMV_01_V_res = MC_H_Vtotal/ME1_block_size_V
        KMV_01_VDE_res = MC_H_Vact/ME1_block_size_V
        KMV_01_CPR_ratio = ME_CPR_ratio
        KMV_01_Bandwidth = KMV_01_frame_rate*KMV_01_bits*KMV_01_H_res*KMV_01_V_res/KMV_01_CPR_ratio/8/1000/1000*MEMC_en*IF(PC_mode, 0, 1)
        KMV_01_DDR_size = KMV_01_bits*KMV_01_H_res*KMV_01_VDE_res/KMV_01_CPR_ratio/8/1024/1024*MEMC_en*IF(PC_mode, 0, 1)
    ...
    def get_regs(self, reg_dict):
        ...
        self.start_addr = reg_mv01_start_address0
        self.end_addr = reg_mv01_end_address0
