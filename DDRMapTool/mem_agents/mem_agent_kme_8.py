...
class MemAgent_KME_8(MemAgent):
    ...
    def calc_memory(self):
        KME_8_frame_rate = GV.ME_in_framerate
        KME_8_bits = GV.ME_bits
        KME_8_H_res = GV.MC_H_Hact/GV.LOGO_MC_ratio_H
        KME_8_V_res = GV.MC_H_Vtotal/GV.LOGO_MC_ratio_V
        KME_8_VDE_res = GV.MC_H_Vact/GV.LOGO_MC_ratio_V
        KME_8_CPR_ratio = GV.ME_CPR_ratio
        KME_8_Bandwidth = KME_8_frame_rate*KME_8_bits*KME_8_H_res*KME_8_V_res/KME_8_CPR_ratio/8/1000/1000*GV.MEMC_en*IF(GV.PC_mode, 0, 1)
        KME_8_DDR_size = KME_8_bits*KME_8_H_res*KME_8_VDE_res/KME_8_CPR_ratio/8/1024/1024*GV.MEMC_en*IF(GV.PC_mode, 0, 1)
