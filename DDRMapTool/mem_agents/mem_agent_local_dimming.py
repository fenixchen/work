...
class MemAgent_LOCAL_DIMMING_W(MemAgent):
    ...
    def calc_memory(self):
        Local_Dimming_W_frame_rate = output_refresh_rate
        ...
        Local_Dimming_W_Bandwidth = Local_Dimming_W_frame_rate*Local_Dimming_W_bits*Local_Dimming_W_H_res * \
            Local_Dimming_W_VDE_res/Local_Dimming_W_CPR_ratio/8/1000/1000*2*(IF(Local_Dimming_en == 1, 1, 0))
        Local_Dimming_W_DDR_size = ROUNDUP(Local_Dimming_W_H_res*Local_Dimming_W_bits/8/1024, 0)*1024*Local_Dimming_W_VDE_res/Local_Dimming_W_CPR_ratio/1024/1024*4*(IF(Local_Dimming_en == 1, 1, 0))
...
class MemAgent_LOCAL_DIMMING_R(MemAgent):
    ...
    def calc_memory(self):
        Local_Dimming_R_frame_rate = output_refresh_rate
        ...
        Local_Dimming_R_Bandwidth = Local_Dimming_R_frame_rate*Local_Dimming_R_bits*Local_Dimming_R_H_res * \
            Local_Dimming_R_VDE_res/Local_Dimming_R_CPR_ratio/8/1000/1000*2*(IF(Local_Dimming_en == 1, 1, 0))
