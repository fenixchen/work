...
class MemAgent_LOCAL_CONTRAST_1_W(MemAgent):
    ...
    def calc_memory(self):
        Local_Contrast_1_W_frame_rate = video_input_refresh_rate
...
class MemAgent_LOCAL_CONTRAST_1_R(MemAgent):
    ...
    def calc_memory(self):
        Local_Contrast_1_R_frame_rate = video_input_refresh_rate
...
class MemAgent_LOCAL_CONTRAST_2_W(MemAgent):
    ...
    def calc_memory(self):
        Local_Contrast_2_W_frame_rate = video_input_refresh_rate
...
class MemAgent_LOCAL_CONTRAST_2_R(MemAgent):
    ...
    def calc_memory(self):
        Local_Contrast_2_R_frame_rate = video_input_refresh_rate
